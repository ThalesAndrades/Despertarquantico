    ...
    <div class="auth-page">
        <div class="auth-card">
            ...
            <div class="auth-logo">
                ...
                <p>Receba um link no seu e-mail e volte para a sua area sem complicacao.</p>
            ...
            <form method="POST" action="<?= url('forgot-password') ?>">
                ...
                <button type="submit" class="auth-submit">Receber link no meu e-mail</button>
            </form>

            <p class="auth-action-note">Use o mesmo e-mail da sua compra ou do seu cadastro.</p>
