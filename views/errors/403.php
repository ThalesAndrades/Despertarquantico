...
$message = isset($message) ? (string) $message : 'Voce nao tem permissao para acessar esta pagina.';
?>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Acesso negado | <?= htmlspecialchars($appName, ENT_QUOTES, 'UTF-8') ?></title>
